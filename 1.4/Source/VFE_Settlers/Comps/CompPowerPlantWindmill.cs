...
namespace VFE_Settlers.Comps
{
    ...
    public class CompPowerPlantWindmill : CompPowerPlant
    {
        ...
        private static readonly Material WindTurbineBladesMat = MaterialPool.MatFrom("Things/Buildings/Windmill/WindmillBlades");
